...
function OracleInstance (config) {
  ...
  underscore.bindAll(this, 'isOracleEvent', 'isValidOracleInstance', 'getCbAddresByConnector', 'getConnectorByOAR', 'getContractInstance', 'checkAccountBalance', 'deployOAR', 'deployConnector', 'sendTx', 'buildLocalTx', 'setCbAddress', 'setAddr')
}
...
OracleInstance.prototype.sendTx = function (txData, callback) {
  if (this.mode === 'active') {
    if (typeof txData !== 'object') throw new Error('tx data provided is not valid')
